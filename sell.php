    ...
    <body>
        ...
        <section class="sale info">
            <div class="first-info">
                <h6>sell more</h6>
                <p>Irrespective of your location, Ieka provides an opportunity to reach out to prospective customers outside your location. You can sell to corporations, households, individuals, restaurants, hotels, retailers and even customers off the shores of your resident country.</p>
            </div>
            <div class="values">
                <h6>trust us</h6>
                <p>We are based on integrity transactions, ensuring that transacting parties are duly represented and satisfied.<br/><a href="#">see our policy</a></p>
            </div>
            <div class="agric">
                <h6>Agriculture to the World</h6>
                <p>Farmers and agro products dealers should only worry about their farms and storage houses. They shouldn't not have to worry about display houses in market places, enhancing a nature friendly habitat</p>
            </div>
        </section>

        <section class="other services">
            <div class="sellguide">
                <a href="">Build your brand with Ieka   <img class="click" src="./assets/icons/ionicons-2.0.1/png/512/android-arrow-up-right.png"></a>
                <a href="">Information on selling online   <img src="./assets/icons/ionicons-2.0.1/png/512/android-arrow-up-right.png"></a>
                <a href="">Guidelines on having a farm account on Ieka   <img src="./assets/icons/ionicons-2.0.1/png/512/android-arrow-up-right.png"></a>
                <a href="">Advertise your farm products on Ieka   <img src="./assets/icons/ionicons-2.0.1/png/512/android-arrow-up-right.png"></a>
                <a href="">Partner with Ieka   <img src="./assets/icons/ionicons-2.0.1/png/512/android-arrow-up-right.png"></a>               
            </div>

            <div class="associate">
                <a href="">Want to partner with other farmers within your location?   <img src="./assets/icons/ionicons-2.0.1/png/512/android-arrow-up-right.png"></a>
                <a href="">Access grants available for farmers   <img src="./assets/icons/ionicons-2.0.1/png/512/android-arrow-up-right.png"></a>
                <a href="">Own multiple accounts on Ieka   <img src="./assets/icons/ionicons-2.0.1/png/512/android-arrow-up-right.png"></a>
                <a href="">Confine your operations within your location   <img src="./assets/icons/ionicons-2.0.1/png/512/android-arrow-up-right.png"></a>
                <a href="">Discuss with Ieka   <img src="./assets/icons/ionicons-2.0.1/png/512/android-arrow-up-right.png"></a>      
            </div>
        </section>
